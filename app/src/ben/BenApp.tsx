...
import BenPipelineView from './BenPipelineView'
import BenOnboardingView from './BenOnboardingView'
      ...
      <main>
        {tab === 'pipeline' && (
          <>
            ...
            <BenPipelineView month={month} />
          </>
        )}
        {tab === 'onboarding' && <BenOnboardingView month={month} />}
      </main>
